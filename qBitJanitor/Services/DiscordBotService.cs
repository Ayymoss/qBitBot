...
public class DiscordBotService
{
    ...
    public DiscordBotService(DiscordSocketClient client, ILogger<DiscordBotService> logger, IOptionsMonitor<Configuration> optionsMonitor,
